 ...
 *
 * @constructor plur/error/Invalid
 * @extends plur/error/Error
 **
 * @params {string} message
 * @params {=} data
 */
var InvalidError = function(message, data) {
...
InvalidError.prototype = PlurObject.create('plur/error/Invalid', InvalidError, PlurError);
