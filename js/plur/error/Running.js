 ...
 *
 * @constructor plur/error/Running
 * @extends plur/error/Error
 **
 * @params {string} message
 * @params {=} data
 */
var RunningError = function(message, data) {
...
RunningError.prototype = PlurObject.create('plur/error/Running', RunningError, PlurError);
