 ...
 *
 * @constructor plur/error/Unsupported
 * @extends plur/error/Error
 **
 * @params {string} message
 * @params {=} data
 */
var UnsupportedError = function(message, data) {
...
UnsupportedError.prototype = PlurObject.create('plur/error/Unsupported', UnsupportedError, PlurError);
