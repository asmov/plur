 ...
 *
 * @constructor plur/error/Request
 * @extends plur/error/Error
 **
 * @params {string} message
 * @params {=} data
 */
var RequestError = function(message, data) {
...
RequestError.prototype = PlurObject.create('plur/error/Request', RequestError, PlurError);
