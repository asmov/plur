 ...
 *
 * @constructor plur/error/Untrusted
 * @extends plur/error/Error
 **
 * @params {string} message
 * @params {=} data
 */
var UntrustedError = function(message, data) {
...
UntrustedError.prototype = PlurObject.create('plur/error/Untrusted', UntrustedError, PlurError);
