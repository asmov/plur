 ...
 *
 * @constructor plur/error/Command
 * @extends plur/error/Error
 **
 * @params {string} message
 * @params {=} data
 */
var CommandError = function(message, data) {
...
CommandError.prototype = PlurObject.create('plur/error/Command', CommandError, PlurError);
