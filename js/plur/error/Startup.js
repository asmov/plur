 ...
 *
 * @constructor plur/error/Startup
 * @extends plur/error/Error
 **
 * @params {string} message
 * @params {=} data
 */
var StartupError = function(message, data) {
...
StartupError.prototype = PlurObject.create('plur/error/Startup', StartupError, PlurError);
