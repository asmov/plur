 ...
 *
 * @constructor plur/error/Encryption
 * @extends plur/error/Error
 **
 * @params {string} message
 * @params {=} data
 */
var EncryptionError = function(message, data) {
...
EncryptionError.prototype = PlurObject.create('plur/error/Encryption', EncryptionError, PlurError);
