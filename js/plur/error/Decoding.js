 ...
 *
 * @constructor plur/error/Decoding
 * @extends plur/error/Error
 **
 * @params {string} message
 * @params {=} data
 */
var DecodingError = function(message, data) {
...
DecodingError.prototype = PlurObject.create('plur/error/Decoding', DecodingError, PlurError);
