 ...
 *
 * @constructor plur/error/NotRunning
 * @extends plur/error/Error
 **
 * @params {string} message
 * @params {=} data
 */
var NotRunningError = function(message, data) {
...
NotRunningError.prototype = PlurObject.create('plur/error/NotRunning', NotRunningError, PlurError);
