 ...
 *
 * @constructor plur/error/Encoding
 * @extends plur/error/Error
 **
 * @params {string} message
 * @params {=} data
 */
var EncodingError = function(message, data) {
...
EncodingError.prototype = PlurObject.create('plur/error/Encoding', EncodingError, PlurError);
