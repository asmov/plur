 ...
 *
 * @constructor plur/error/Undefined
 * @extends plur/error/Error
 **
 * @params {string} message
 * @params {=} data
 */
var UndefinedError = function(message, data) {
...
UndefinedError.prototype = PlurObject.create('plur/error/Undefined', UndefinedError, PlurError);
