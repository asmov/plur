 ...
 *
 * @constructor plur/error/Disconnected
 * @extends plur/error/Error
 **
 * @params {string} message
 * @params {=} data
 */
var DisconnectedError = function(message, data) {
...
DisconnectedError.prototype = PlurObject.create('plur/error/Disconnected', DisconnectedError, PlurError);
