 ...
 *
 * @constructor plur/error/Operator
 * @extends plur/error/Error
 **
 * @params {string} message
 * @params {=} data
 */
var OperatorError = function(message, data) {
...
OperatorError.prototype = PlurObject.create('plur/error/Operator', OperatorError, PlurError);
