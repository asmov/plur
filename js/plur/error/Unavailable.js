 ...
 *
 * @constructor plur/error/Unavailable
 * @extends plur/error/Error
 **
 * @params {string} message
 * @params {=} data
 */
var UnavailableError = function(message, data) {
...
UnavailableError.prototype = PlurObject.create('plur/error/Unavailable', UnavailableError, PlurError);
