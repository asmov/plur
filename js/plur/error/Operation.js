 ...
 *
 * @constructor plur/error/Operation
 * @extends plur/error/Error
 **
 * @params {string} message
 * @params {=} data
 */
var OperationError = function(message, data) {
...
OperationError.prototype = PlurObject.create('plur/error/Operation', OperationError, PlurError);
