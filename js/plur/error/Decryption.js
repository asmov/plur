 ...
 *
 * @constructor plur/error/Decryption
 * @extends plur/error/Error
 **
 * @params {string} message
 * @params {=} data
 */
var DecryptionError = function(message, data) {
...
DecryptionError.prototype = PlurObject.create('plur/error/Decryption', DecryptionError, PlurError);
