 ...
 *
 * @constructor plur/error/Permission
 * @extends plur/error/Error
 **
 * @params {string} message
 * @params {=} data
 */
var PermissionError = function(message, data) {
...
PermissionError.prototype = PlurObject.create('plur/error/Permission', PermissionError, PlurError);
