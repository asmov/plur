 ...
 *
 * @constructor plur/error/Offline
 * @extends plur/error/Error
 **
 * @params {string} message
 * @params {=} data
 */
var OfflineError = function(message, data) {
...
OfflineError.prototype = PlurObject.create('plur/error/Offline', OfflineError, PlurError);
