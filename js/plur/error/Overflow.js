 ...
 *
 * @constructor plur/error/Overflow
 * @extends plur/error/Error
 **
 * @params {string} message
 * @params {=} data
 */
var OverflowError = function(message, data) {
...
OverflowError.prototype = PlurObject.create('plur/error/Overflow', OverflowError, PlurError);
