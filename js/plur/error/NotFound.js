 ...
 *
 * @constructor plur/error/NotFound
 * @extends plur/error/Error
 **
 * @params {string} message
 * @params {=} data
 */
var NotFoundError = function(message, data) {
...
NotFoundError.prototype = PlurObject.create('plur/error/NotFound', NotFoundError, PlurError);
