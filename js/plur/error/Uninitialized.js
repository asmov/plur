 ...
 *
 * @constructor plur/error/Uninitialized
 * @extends plur/error/Error
 **
 * @params {string} message
 * @params {=} data
 */
var UninitializedError = function(message, data) {
...
UninitializedError.prototype = PlurObject.create('plur/error/Uninitialized', UninitializedError, PlurError);
