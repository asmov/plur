 ...
 *
 * @constructor plur/error/Validation
 * @extends plur/error/Error
 **
 * @params {string} message
 * @params {=} data
 */
var ValidationError = function(message, data) {
...
ValidationError.prototype = PlurObject.create('plur/error/Validation', ValidationError, PlurError);
